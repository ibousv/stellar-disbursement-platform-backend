...
func (tw *TransactionWorker) buildAndSignTransaction(ctx context.Context, txJob *TxJob) (feeBumpTx *txnbuild.FeeBumpTransaction, err error) {
	...
	paymentTx, err := tw.buildPaymentTxn(txJob, horizonAccount.Sequence, distributionAccount.Address, asset)
	if err != nil {
...
func (tw *TransactionWorker) buildPaymentTxn(txJob *TxJob, sequence int64, operationSourceAccount string, asset txnbuild.Asset) (*txnbuild.Transaction, error) {
